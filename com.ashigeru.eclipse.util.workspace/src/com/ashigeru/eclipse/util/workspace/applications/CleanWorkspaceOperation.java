...
class CleanWorkspaceOperation extends AbstractOperation {

    public CleanWorkspaceOperation() {
        super("--clean-workspace", null);
    }
    ...
    public void perform(String value) throws Exception {
        ...
        try {
            System.out.println("[CLEAN] Cleaning workspace");
